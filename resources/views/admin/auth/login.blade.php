...
<html>
	...
	<link href="{{ asset('public/bootstrap/css/login.css') }}" rel="stylesheet" type="text/css" />    
	<body class="">
		<div class="">
			@if(session('success'))
					...
					<div class="grid ">
						<form action="{{ route('admin.login') }}" method="POST" class="form login">
							...
							<div class="form__field">
								...
								<input type="text" name="email" class="form__input" placeholder="Enter email id" required>
							</div>
							<div class="form__field">
								<label for="login__username">
									<svg class="icon"><use xlink:href="#icon-user"></use> </svg>
